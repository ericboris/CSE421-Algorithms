...
Draw the maximum s-t flow for the pictured graph, the corresponding residual graph G$_f$, and the minimum cut corresponding to this max flow. 
...
\centering
\includegraphics[scale=0.5]{graphG.png}
